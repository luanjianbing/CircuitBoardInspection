...
public:
    ...
    void setupUi(QWidget *ProcessResultDisplayClass)
    {
        ...
        labelDisplay->setStyleSheet(QString::fromUtf8("background:b"));
        ...
        labelBlockIndex->setFont(font);
        labelBlockIndex->setAlignment(Qt::AlignCenter);

        gridLayout_3->addWidget(labelBlockIndex, 0, 1, 1, 2);
        ...
        labelDetectCate->setFont(font);
        labelDetectCate->setAlignment(Qt::AlignCenter);

        gridLayout_3->addWidget(labelDetectCate, 1, 1, 1, 2);
        ...
        gridLayout_3->addWidget(buttonModify, 6, 0, 1, 2);

        label_8 = new QLabel(widget_2);
        label_8->setObjectName(QString::fromUtf8("label_8"));
        label_8->setAlignment(Qt::AlignCenter);

        gridLayout_3->addWidget(label_8, 5, 0, 1, 2);
        ...
        gridLayout_3->addWidget(label_7, 3, 0, 1, 2);
